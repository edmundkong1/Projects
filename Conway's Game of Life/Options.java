...
class Options extends JPanel
{
    ...
    public Options()
    {
        ...
        final String[] columnNames = {"Variables   ", 
                ...
                "Agent 4"}; 
        final Object [][] data = {
                {"Initial Count", new Integer(20), new Integer(20), new Integer(20), new Integer(20)}, 
                {"Initial Energy", new Integer(100), new Integer(100), new Integer(100), new Integer(100)}, 
                {"Breeding Energy Threshold", new Integer(80), new Integer(80), new Integer(80), new Integer(80)},
                {"Breed Energy", new Integer(60), new Integer(60), new Integer(60), new Integer(60)}, 
                {"Step Energy", new Integer(1), new Integer(1), new Integer(1), new Integer(1)}, 
                {"Aging Rate", new Integer(10), new Integer(10), new Integer(10), new Integer(10)}, 
                {"Age Limit", new Integer(300), new Integer(300), new Integer(300), new Integer(300)},
                {"Fighting Energy", new Integer(1), new Integer(1), new Integer(1), new Integer(1)}, 
            }; 
        ...
        final String[] columnNames1 = {"Variables", 
                ...
                "Food 4"}; 
        final Object [][] data1 = {
                {"Initial amount", new Integer(20), new Integer(20), new Integer(20), new Integer(20)},
                {"Growth Rate", new Double(0.03), new Double(0.03), new Double(0.03), new Double(0.03)}, 
                {"Depletion Rate", new Double(0.3), new Double(0.3), new Double(0.3), new Double(0.3)},
                {"Age Limit", new Integer(300), new Integer(300), new Integer(300), new Integer(300)},
            }; 
        ...
        final Object[][] data4 = {
                {"Contact Transmission Rate", new Double(0.5), new Double(0.5), new Double(0.5), new Double(0.5)},
                {"Child Transmission Rate", new Double(0.9), new Double(0.9), new Double(0.9), new Double(0.9)},
                {"Recovery Time", new Integer(0), new Integer(0), new Integer(0), new Integer(0)}, 
            }; 
